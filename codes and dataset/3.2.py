...
batch_sizes = [1,64,256,xdata_ok.shape[1]]
costs_maps = []
for batch_size in batch_sizes :
    ...
    for i in range(e) :
        ...
        cost = calculate_cost(acts,ydata,ny_data,nx_data)
    ...
    cost_test = calculate_cost(acts_test,ytest,ny_test,nx_data)
...
for ee in range(e):
    iter_map.append(ee)
p1 = plt.plot(iter_map,costs_maps[0],color="blue")
p2 = plt.plot(iter_map,costs_maps[1],color="red")
p3 = plt.plot(iter_map,costs_maps[2],color="black")
p4 = plt.plot(iter_map,costs_maps[3],color="green")    
plt.gca().legend(( '1', '64','256','full'))
plt.show()  
