...
for ee in range(e) :
    iter_map.append(ee)
print(len(costs_maps))
#print(costs_maps[0])
p2 = plt.plot(iter_map,costs_maps[1-1],color="blue")
p3 = plt.plot(iter_map,costs_maps[2-1],color="red")
p4 = plt.plot(iter_map,costs_maps[3-1],color="green")    
plt.gca().legend(( '0', '0.1','0.95'))
plt.show()  
